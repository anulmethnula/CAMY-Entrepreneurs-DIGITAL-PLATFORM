...
CREATE TABLE IF NOT EXISTS stock_supply_requests (
  ...
  total DECIMAL(14,2) NOT NULL,
  supply_mode VARCHAR(30) NOT NULL DEFAULT 'cash_purchase',
  credit_return_due_at DATETIME NULL,
  credit_return_status VARCHAR(40) NULL,
...
CREATE TABLE IF NOT EXISTS shop_orders (
  ...
  entrepreneur_member_id VARCHAR(30) NOT NULL,
  total DECIMAL(14,2) NOT NULL,
  camy_amount DECIMAL(14,2) NOT NULL DEFAULT 0,
  commission_amount DECIMAL(14,2) NOT NULL DEFAULT 0,
  payment_method VARCHAR(30) NOT NULL DEFAULT 'bank_transfer',
  payment_status VARCHAR(40) NOT NULL DEFAULT 'Awaiting payment',
  payment_collected_at DATETIME NULL,
  commission_status VARCHAR(40) NOT NULL DEFAULT 'Not eligible',
  commission_due_at DATETIME NULL,
  commission_paid_at DATETIME NULL,
  commission_reference VARCHAR(120) NULL,
  status VARCHAR(40) NOT NULL DEFAULT 'Pending',
  record_json LONGTEXT NULL,
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS shop_order_items (
  ...
  quantity INT UNSIGNED NOT NULL,
  sell_price DECIMAL(14,2) NOT NULL,
  camy_unit_price DECIMAL(14,2) NOT NULL DEFAULT 0,
  commission_amount DECIMAL(14,2) NOT NULL DEFAULT 0,
